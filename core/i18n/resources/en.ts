...
export const en = {
  ...
  locale: {
    ...
    settingDescription: 'Choose the language for Anubis Agent UI and model behavior.',
    auto: 'Follow browser',
    zhCN: '简体中文',
    en: 'English',
  },
  sidepanel: {
    ...
    githubSkillImport: {
      ...
      description: 'Supports repositories, directories, and single SKILL.md links. Anubis Agent previews content before import and never overwrites local custom Skills.',
    ...
    localSkillImport: {
      ...
      description: 'Reads a local Skill folder through Shell MCP. Anubis Agent keeps the folder reference and never executes scripts during import.',
    ...
    whatsNew: {
      ...
      dismiss: 'Got it',
      items: {
        browserControl: 'Browser Control can select a target tab from the side panel and perform visible web actions for Anubis Agent.',
    ...
    memoryPage: {
      title: 'Memory',
      description: 'Manage the preferences, feedback, topic context, and references that influence future Anubis Agent replies.',
      ...
      emptyHelp: 'Anubis Agent saves durable preferences and project context from conversation, and you can add entries manually.',
    ...
    settings: {
      ...
      petWhale: 'Anubis Mascot',
      petWhaleDescription: 'Show Anubis — the guardian jackal — with chat response bubbles',
      ...
      floatingPetSection: 'Anubis Mascot',
    ...
    promptControls: {
      ...
      systemPrompt: 'Anubis Agent system prompt',
    ...
    browserControlPage: {
      ...
      description: 'Let Anubis Agent control a selected Chrome or Edge tab through the browser debugger and Accessibility Tree.',
    ...
    mcpPage: {
      title: 'MCP',
      description: 'Connect local or remote MCP services so Anubis Agent can discover tools, control auto execution, and return results.',
    ...
    chatPage: {
      ...
      inputPlaceholder: 'Message Anubis Agent',
      send: 'Send',
  ...
  content: {
    ...
    historyOrganizer: {
      enhancedSearchTitle: 'Anubis Agent search enhancements',
      ...
      emptySearchStatus: 'Anubis Agent: waiting for official search results',
      visibleStatus: 'Anubis Agent: {visible}/{total} visible',
      loadError: 'Anubis Agent: failed to load history tags: {message}',
      saveError: 'Anubis Agent: failed to save history tags: {message}',
    },
    projectSidebar: {
      title: 'Projects',
    ...
    toolBlock: {
      ...
      missingSandboxResultDetail: 'The sandbox tool did not return an execution result. Reload the Anubis Agent extension and refresh the current DeepSeek page, then try again; it does not depend on MCP or Shell Local.',
    ...
    agent: {
      ...
      budgetReached: 'Anubis Agent paused after {count} automated tool-continuation rounds to avoid presenting incomplete work as a final answer. Send "continue" in this conversation to resume the remaining work.',
      error: 'Execution error',
      footerComplete: 'Agent complete ({steps} steps, {tools} tool calls)',
      footerError: 'Agent error ({steps} steps, {tools} tool calls)',
    },
    permission: {
      webFetch: 'Anubis Agent needs permission to access {origin} so it can fetch that page',
      deny: 'Deny',
      grant: 'Allow',
    ...
    multimodalMedia: {
      buttonTitle: 'Add Anubis Agent multimodal images or videos',
  ...
  tool: {
    ...
    memory: {
      providerName: 'Anubis Agent Memory',
    ...
    web: {
      providerName: 'Anubis Agent Web Search',
      ...
      permissionDenied: 'The extension does not have permission to access Bing. Remove and reload the dist/chrome-mv3 extension directory, or confirm cn.bing.com is listed under site access in chrome://extensions -> Anubis Agent details.',
    ...
    browser: {
      providerName: 'Anubis Agent Browser Control',
